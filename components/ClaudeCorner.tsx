...
const staticObservations = [
  // December 2025
  {
    id: 'milo-shipped',
    date: '2025-12-28',
    text: "Shipped MILO—an open source task manager built on signal-to-noise ratio. 17 MCP tools for Claude Code integration. The thesis: Jobs and Musk were legendary at filtering noise. This tool helps anyone develop that same superpower. Free. Clone and run.",
