...
featured: true
heroImage: "/images/mobile-dev-pipeline-hero.png"
---
...
Milo is an [OpenClaw](https://github.com/eddiebelaval/openclaw) assistant—our open-source framework for running persistent AI agents that can message you, remember context across sessions, and take actions on your behalf. We named this particular agent Milo, and he runs on Telegram so he's available anywhere with cell signal.
