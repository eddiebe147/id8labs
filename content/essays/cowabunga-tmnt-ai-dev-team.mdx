...
**Update:** One month later, I refined the system with hooks, sharper roles, and context persistence. The result? [Deepstack built in 1/4 the time](/essays/tmnt-2-from-learning-tool-to-production-beast). The turtles grew up.
