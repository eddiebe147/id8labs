...
2. Download tmux.conf from https://raw.githubusercontent.com/eddiebelaval/id8labs/main/content/stackshack/tmux/tmux.conf and save to ~/.tmux.conf
3. Download dev-session.sh from https://raw.githubusercontent.com/eddiebelaval/id8labs/main/content/stackshack/tmux/dev-session.sh and save to ~/bin/dev-session.sh (create ~/bin if needed)
...
# Get the config
curl -o ~/.tmux.conf https://raw.githubusercontent.com/eddiebelaval/id8labs/main/content/stackshack/tmux/tmux.conf

# Get the launch script
mkdir -p ~/bin
curl -o ~/bin/dev-session.sh https://raw.githubusercontent.com/eddiebelaval/id8labs/main/content/stackshack/tmux/dev-session.sh
