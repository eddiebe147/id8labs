    ...
    <div className="container py-24">
      <article className="max-w-4xl mx-auto">
        ...
        <section className="mb-16">
          <h2 className="text-3xl font-bold mb-8">The 9-Agent System</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            {agents.map((agent) => (
              <div
                key={agent.name}
                className="p-5 bg-[var(--bg-secondary)] border border-[var(--border)] rounded-soft"
              >
...
└── references/          # Deep knowledge base
    ...
    └── ... (8 reference docs)`}</pre>
        ...
        {/* Comparison */}
        <section className="mb-16">
          <h2 className="text-3xl font-bold mb-8">Traditional vs. Agent-Based</h2>
        ...
        <section className="mb-16 p-8 bg-[var(--id8-orange)]/5 border-2 border-[var(--id8-orange)]/20 rounded-soft">
          <h3 className="text-2xl font-bold mb-4 text-[var(--id8-orange)]">What You Get</h3>
        ...
        {/* CTA */}
        <section className="mb-16 p-12 bg-gradient-to-br from-[var(--id8-orange)]/10 to-[var(--id8-orange)]/5 border-2 border-[var(--id8-orange)]/30 rounded-soft text-center">
          <h2 className="text-3xl font-bold mb-4">Need a Custom Agent System?</h2>
